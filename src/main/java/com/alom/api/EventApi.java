...
public class EventApi {
	...
	public PaginationResponse<EventMasterDto> viewEventByDate(@RequestParam LocalDate fromEventDate,
			@RequestParam LocalDate uptoEventDate, @RequestParam(defaultValue = "0") int page,
